 ...
 * @author ANTHONY
 */
public class frmResponsableOllita extends javax.swing.JFrame {

    /**
     * Creates new form frmResponsableOllita
     */
    public frmResponsableOllita() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 350, 230));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmResponsableOllita.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmResponsableOllita().setVisible(true);
            }
        });
    }
