 ...
 * @author pumak
 */
public class frmRegistrarEntrega extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmRegistrarEntrega.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
